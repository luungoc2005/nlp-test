...
from common.utils import n_letters, all_letters
from config import LM_VOCAB_SIZE, LM_CHAR_RESERVED, START_TAG, STOP_TAG, UNK_TAG, MAX_SEQUENCE_LENGTH

class DualFeaturizer(IFeaturizer):

    def __init__(self, config=dict()):
        super(DualFeaturizer, self).__init__()
        ...
        self.char_tokenizer.fit_on_texts([all_letters])
